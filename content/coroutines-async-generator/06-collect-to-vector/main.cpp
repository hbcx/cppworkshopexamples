...
// The async analog of draining a range into a container: co_await every element
// and append it. This is the bridge from a stream to a plain value the rest of
// the program can use once the loop has finished.
Task collect(async_generator<int>& gen, std::vector<int>& out) {
